...
Se puede notar que todas la variables proporcionan buena información al modelo de regresión, la única variable que proporciona menos información que las demás, es la variable de año.
...
pollution_transf <- pollution[,-11]
pollution_transf <- cbind2(pollution_transf, iws)
names(pollution_transf)[13]<- "Iws"
...
No todo conjunto de datos puede ser aproximado por una regresión lineal, ya que puede que la regresión no cumpla ciertos supuestos. Debido a ello buscaremos hacer una regresión utilizando arboles.