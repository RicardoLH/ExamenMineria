...
summary(reg_tree)
rsq.rpart(reg_tree)
pruned_tree <- prune(reg_tree, cp=0.010000)
pruned_tree
...
1 - sum((y-pruned_tree_predictions_val)^2)/sum((y-mean(y))^2)
cor(pruned_tree_predictions_val, y)^2
```
